...
const Count = () => {
    ...
    return (
        <div className='flex flex-col lg:flex-row'>
            <section className="bg-white" data-aos="fade-right"  style={{ background: darkMode ? '#252525' : 'white'}}>
                <div className="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 md:py-16 lg:px-8">
                    <div className="mx-auto max-w-3xl text-center">
                        <h2 className="text-3xl font-bold text-gray-900 sm:text-4xl" style={{ color: darkMode ? 'white' : '#111827' }}>
                            Explore the impact of our platform with these key statistics.
                        </h2>

                        <p className="mt-4 text-gray-500 sm:text-xl" style={{ color: darkMode ? 'white' : '#6b7280' }}>
