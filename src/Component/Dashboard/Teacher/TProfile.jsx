   ...
   useEffect(()=>{
    ...
    return (
        ...
        <div className='flex flex-col md:flex-row justify-center items-center mt-24'>
            <div className='flex-1 text-start bg-[#252525] text-white mx-4 rounded px-8 py-8 leading-4' data-aos="fade-up">
            ...
            <div className='flex-1'><img id='floating' src="https://i.ibb.co/QfTJR75/undraw-Profile-re-4a55.png"  data-aos="fade-up"/></div>
        </div>
    </div>
    );
};
